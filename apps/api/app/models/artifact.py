...
class Artifact(Base):
    ...
    type: Mapped[str] = mapped_column(String, nullable=False)  # IdeaContract|EvidenceBrief|ProductSpec|...
    ...
    status: Mapped[str] = mapped_column(String, default="submitted")  # submitted|approved|rejected|superseded
    review_state: Mapped[str | None] = mapped_column(String, nullable=True)  # pending|passed|revision_requested|escalated
