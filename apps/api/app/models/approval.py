...
class Approval(Base):
    ...
    gate_type: Mapped[str] = mapped_column(String, nullable=False)  # sensitive-data-retention|external-write|...
    ...
    status: Mapped[str] = mapped_column(String, default="PENDING")  # PENDING|APPROVED|REJECTED|CHANGES_REQUESTED
