...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "cost_usd", sa.Numeric(precision=10, scale=4), server_default="0.0", nullable=True
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "retrieved_at", sa.DateTime(timezone=True), server_default=sa.func.now(), nullable=True
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "requested_at", sa.DateTime(timezone=True), server_default=sa.func.now(), nullable=True
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "cost_usd", sa.Numeric(precision=10, scale=6), server_default="0.0", nullable=True
        ),
        sa.Column("tool_calls", sa.Integer(), server_default="0", nullable=True),
        sa.Column("outcome", sa.String(), nullable=True),
        sa.Column(
            "recorded_at", sa.DateTime(timezone=True), server_default=sa.func.now(), nullable=True
        ),
